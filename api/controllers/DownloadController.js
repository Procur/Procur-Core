      ...
      Company.findOne({
        ...
        Buyer.findOne({
          ...
          async.times(5, function(n, next) {
            if (req.files["downloadURI" + n]) {
              if (b["downloadTitle" + n] && b["downloadTitle" + n][0] != "" && req.files["downloadURI" + n].headers['content-type'] != "application/octet-stream" && req.files["downloadURI" + n].size < maxSize) {
                //console.log("cur N: "+n);
